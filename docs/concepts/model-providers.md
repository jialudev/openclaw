...
- Older `openai-codex/gpt-5.1*`, `openai-codex/gpt-5.2*`, `openai-codex/gpt-5.3*`, `openai-codex/gpt-5.4-pro`, and `openai-codex/gpt-5.5-pro` refs are suppressed because ChatGPT/Codex OAuth accounts reject them; use `openai-codex/gpt-5.5` or the native Codex runtime route instead.
